"""
Django settings for money_mint project.
...
SECRET_KEY = 'django-insecure-4mm8c@nvqp%-7m44_buaznl^&$dvii*r1l0kp_@)^ax=o)shco'
...
WSGI_APPLICATION = 'money_mint.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Add the directory containing your Bootstrap files.
]
